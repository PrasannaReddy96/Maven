...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser()throws Throwable 
	{
		...
		{
			System.setProperty("webdriver.gecko.driver", "D:\\LIVE_PROJECT\\ERP_Maven\\CommonDrivers\\geckodriver.exe");
		}
		else 
		{
			...
			String locatorvalue,String waittime)
	{
		...
		{
			System.out.println("wait for element is failed");
		}
	}
			...
			String testdata)
	{
		...
		else if(locatortype.equalsIgnoreCase("name"))
		{
			...
			System.out.println("Type action is failed");
		}
	}
	...
	public static void captureData(WebDriver driver, String locatorname,String locatorvalue)throws Throwable
	{
		...
		FileWriter fw=new FileWriter("D:\\LIVE_PROJECT\\ERP_Maven\\CaptureData\\snumber.txt");
	...
	{
		//read snumber from notepad
		FileReader fr=new FileReader("D:\\LIVE_PROJECT\\ERP_Maven\\CaptureData\\snumber.txt");
		BufferedReader br=new BufferedReader(fr);
		String exp_data=br.readLine();
		//convert testdata into interger
		...
		Thread.sleep(4000);
		//enter exp_data into search textbox
		driver.findElement(By.xpath(PropertyFileUtil.getValueForKey(""))).sendKeys(exp_data);
		Thread.sleep(4000);
